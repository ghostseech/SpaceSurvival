...
import com.asdfgaems.utils.TileDrawer;
...
public class TileMap extends Actor {
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        batch.draw(ResourseLoader.instance.getTextureRegion("not_visited"), 0, - Vars.tileSize, Vars.tileSize * (width + 1), Vars.tileSize);
        batch.draw(ResourseLoader.instance.getTextureRegion("not_visited"), Vars.tileSize * width, 0, Vars.tileSize, Vars.tileSize * (height + 1));
    }
